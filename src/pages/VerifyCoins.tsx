...
const VerifyCoins = () => {
  ...
  useEffect(() => {
    ...
    // Check authentication before allowing form access
    if (!user) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-8 pb-16">
          ...
          <DialogContent className="sm:max-w-md rounded-xl bg-white border border-gray-200 shadow-2xl">
            ...
            <div className="flex flex-col items-center space-y-4 p-6">
              ...
              <p className="text-center text-gray-600">
                Please log in to use our coin verification service. This helps us provide better support and track your verification history.
              </p>
        ...
        {/* Only show form content if user is authenticated */}
        {user && (
      ...
      {/* ... keep existing code (QR modal, success modal, agent modal) */}
