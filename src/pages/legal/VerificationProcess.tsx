              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 max-w-md mx-auto">
                    We are currently preparing detailed information about our coin verification process. 
                    This page will explain how our experts authenticate and evaluate coins.
                  </p>
                </div>
              </div>
            </div>
